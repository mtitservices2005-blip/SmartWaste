...
> Datos demo · no producción. Describes the schema in `supabase/migrations/`, applied and verified
> against a local Supabase instance as of SW-020 (see `docs/CURRENT_STATE_AUDIT.md`) — not a live
> production database.
